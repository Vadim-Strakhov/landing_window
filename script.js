...
const changeModalState = state => {
  ...
  (0,_checkNumInputs__WEBPACK_IMPORTED_MODULE_0__["default"])("#width"); //_ Валидация инпута с шириной
  (0,_checkNumInputs__WEBPACK_IMPORTED_MODULE_0__["default"])("#height"); //_ Валидация инпута  с высотой

  function bindActionToElems(event, elem, prop) {
    //_ Функция для получения выбранных данных из формы-калькулятора
    elem.forEach((item, i) => {
...
const forms = state => {
  ...
  (0,_checkNumInputs__WEBPACK_IMPORTED_MODULE_0__["default"])("input[name='user_phone']"); // //_ Валидация инпута через модуль
  ...
  form.forEach(item => {
    item.addEventListener("submit", e => {
      ...
      postData("assets/server.php", formData).then(res => {
        // console.log(res);
        console.log("На gh pages отправка формы на сервер, к сожалению, не сработает, но сообщение благодарности все равно появится");
        statusMessage.textContent = message.success;
      }).catch(() => statusMessage.textContent = message.failrule).finally(() => {
        clearInputs();
        setTimeout(() => {
...
const tabs = (headerSelector, tabSelector, contentSelector, activeClass, display = "block") => {
  ...
  //_ Условие на проверку кликов именно по табу
...
window.addEventListener("DOMContentLoaded", () => {
  ...
  // let deadline = "2024-03-23"; //_ Установка таймера на конкретную дату
  ...
  (0,_modules_tabs__WEBPACK_IMPORTED_MODULE_2__["default"])(".glazing_slider", ".glazing_block", ".glazing_content", "active"); //_ Для верхних табов
  (0,_modules_tabs__WEBPACK_IMPORTED_MODULE_2__["default"])(".decoration_slider", ".no_click", ".decoration_content > div > div", "after_click"); //_ Для нижних табов
  (0,_modules_tabs__WEBPACK_IMPORTED_MODULE_2__["default"])(".balcon_icons", ".balcon_icons_img", ".big_img > img", "do_image_more", "inline-block"); //_Для табов в формах-калькуляторах
  (0,_modules_forms__WEBPACK_IMPORTED_MODULE_3__["default"])(modalState);
  (0,_modules_timer__WEBPACK_IMPORTED_MODULE_5__["default"])(".container1", deadlineTomorrow);
  (0,_modules_images__WEBPACK_IMPORTED_MODULE_6__["default"])();

  //_ Получение текущего времени локальном часовом поясе
  // const localTime = new Date();
  // console.log("Local Time:", localTime.toLocaleString());

  //_ Получение текущего времени сервере
